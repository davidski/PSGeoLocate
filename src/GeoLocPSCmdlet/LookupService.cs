...
namespace GeoLocPSCmdlet
{
    ...
    // again, curious that they embed so much data in the code rather
    // than having it in their data tables
    ...
    public class LookupService
    {
       ...
       "N/A","Asia/Pacific Region","Europe","Andorra","United Arab Emirates","Afghanistan","Antigua and Barbuda","Anguilla","Albania","Armenia","Curacao",
        ...
        public LookupService(String databaseFile, int options)
        {
            ...
            {
                throw new Exception(String.Format("Cannot open database file: {0}", databaseFile), ex);
            }
        }
